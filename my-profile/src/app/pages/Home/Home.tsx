...
const Home = () => {
  return (
    <div>
      <div className='bg-[#262626] h-screen w-screen'>
    ...
    }} className='w-[40rem] h-[70vh] mt-[-20px] border border-1 border-white border-t-0 flex flex-col items-center justify-end'>
